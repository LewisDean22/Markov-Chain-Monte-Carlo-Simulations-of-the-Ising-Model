...
def plot_all_energies(energy_filenames, save_all=SAVE_ALL,
    ...
    for count, data in enumerate(plot_data):
        (length, temperature_data, energy_plot_data,
...
def plot_all_magnetisations(magnetisation_filenames, save_all=SAVE_ALL,
    ...
    for count, data in enumerate(plot_data):
        (length, temperature_data, magnetisation_plot_data,
         magnetisation_abs_plot_data, susceptibility_data, curie_temp) = data
...
def main(directory=WORKING_DIRECTORY):
    ...
    if plot_seperate:
        ...
        for magnetisation_filename in magnetisation_data_list:
            (length, temperature_data, magnetisation_plot_data,
             magnetisation_abs_plot_data, susceptibility_data, curie_temp) = (
            ...
            # Relative permeabililty plot
            # plot_susceptibility(lattice_size, temperature_data,
            #                     find_relative_permeability(susceptibility_data))
